...
public class HeadersForwardingEurekaTest {
  ...
  public static void enableEureka() {
    System.setProperty("EUREKA_LOGIN_PERMS", "true");
  }
  ...
  @Test
  public void testPostBlUsersLoginLegacy_eureka() {
  ...
  @Test
  public void testPostBlUsersLogin_eureka() {
    LoginCredentials credentials = new LoginCredentials();
    credentials.setUsername(USERNAME);
    credentials.setPassword("password");
